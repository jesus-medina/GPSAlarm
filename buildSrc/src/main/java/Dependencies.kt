object Versions {
    ...
    object Moko {
        const val geo = "0.4.0"
        const val parcelize = "0.7.1"
        const val permission = "0.10.2"
    }
}
...
object Deps {
    ...
    object Android {
        val playServicesLocation = "com.google.android.gms:play-services-location:${Versions.Android.playServicesLocation}"
    }
    ...
    object Orbit {
        val common = "org.orbit-mvi:orbit-core:${Versions.orbit}"
        val android = "org.orbit-mvi:orbit-viewmodel:${Versions.orbit}"
        val test = "org.orbit-mvi:orbit-test:${Versions.orbit}"
    }

    object Moko {
        val geo = "dev.icerock.moko:geo:${Versions.Moko.geo}"
        val parcelize = "dev.icerock.moko:parcelize:${Versions.Moko.parcelize}"
        val permission = "dev.icerock.moko:permissions:${Versions.Moko.permission}"
    }
}
